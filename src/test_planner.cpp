...
void test_planner(OcTree& tree){
	...
	std::vector<Node*> best_branch = planner(tree, start, num_sample, max_sample, eps, best_IG, tree_vis_array, t);
	...
	best_branch = planner(tree, start, num_sample, max_sample, eps, best_IG, tree_vis_array,t);
	print_node_vector(best_branch);
	cout << "RRT vis array size: " << tree_vis_array.size() << endl;
	cout << "======================================" << endl;
	return;
